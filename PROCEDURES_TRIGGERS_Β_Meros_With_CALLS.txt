/* PROCEDURES AND TRIGGERS for MEROS 2 - GUI - WITH CALLS AND DROPS*/
...
CALL emfanish_aithseis_aksiologiseis_aksiologitis_final('Alexandros','Staurou'); 
CALL emfanish_aithseis_aksiologiseis_aksiologitis_final('Eleni','Libada'); 
CALL emfanish_aithseis_aksiologiseis_aksiologitis_final('Petros','Alexiou'); 
...
UPDATE evaluator
SET username ='asdgdfg', name = 'fdgghty', surname = 'Hello world', exp_years = 26, code = 1234, firm = '123456789', MO = 7.625
WHERE username = 'conmcgr';
...
DROP PROCEDURE AdminManInsert_Frane1;
...
DROP TRIGGER trig_AdminManInsert_Frane1;
...
DROP PROCEDURE AdminEvalInsert_Frane1;
...
DROP TRIGGER trig_AdminEvalInsert_Frane1;
...
DROP TRIGGER trig_AdminEmpInsert_Frane1;